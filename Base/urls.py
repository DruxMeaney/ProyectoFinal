...
urlpatterns = [
    ...
    path('linea/list/', Investigacion_Lista.as_view(), name='investigacion_listar'),
    path('linea/<pk>', Investigacion_Detalle.as_view(), name='investigacion_detalle'),
    path('linea/nuevo/', Investigacion_Creacion.as_view(), name='investigacion_crear'),
    path('linea/editar/<pk>', Investigacion_Edicion.as_view(), name='investigacion_editar'),
    path('linea/borrar/<pk>', Investigacion_Eliminacion.as_view(), name='investigacion_borrar'),
